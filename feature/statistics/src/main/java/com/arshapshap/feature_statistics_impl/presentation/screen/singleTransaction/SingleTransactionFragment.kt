package com.arshapshap.feature_statistics_impl.presentation.screen.singleTransaction
...
import com.arshapshap.common.presentation.dialogs.DatePickerFragment.Companion.showDatePickerDialog
import com.arshapshap.common.presentation.dialogs.DatePickerFragment.OnSelectDateListener
import com.arshapshap.common.presentation.dialogs.PickerFragment.Companion.showPickerDialog
import com.arshapshap.common.presentation.dialogs.PickerFragment.OnSelectListener
import com.arshapshap.common.presentation.editTextFilters.DecimalDigitsInputFilter
...
import com.arshapshap.feature_statistics_impl.databinding.FragmentSingleTransactionBinding
...
import com.arshapshap.feature_statistics_impl.presentation.screen.singleTransaction.tagsRecyclerView.TagsAdapter
...
class SingleTransactionFragment : BaseFragment<SingleTransactionViewModel>(R.layout.fragment_single_transaction),
    ...
    override fun initViews() {
        with (binding.selectCategoryButton) {
            ...
            setImage(com.arshapshap.common.R.drawable.ic_category)
        ...
        with (binding.selectAccountDestinationButton) {
            setStrokeVisibility(false)
            setRightArrowVisible(true)
            setImage(com.arshapshap.common.R.drawable.ic_account)
        ...
        with (binding.selectDateButton) {
            setStrokeVisibility(false)
            setRightArrowVisible(true)
            setImage(com.arshapshap.common.R.drawable.ic_date)
