package com.arshapshap.feature_settings.presentation.screen.settings
...
import com.arshapshap.feature_settings.databinding.FragmentSettingsBinding
...
class SettingsFragment : BaseFragment<SettingsViewModel>(R.layout.fragment_settings),
    ...
    override fun initViews() {
        ...
        with (binding.goToTagsButton) {
            setStrokeVisibility(false)
            setRightArrowVisible(true)
            setImage(com.arshapshap.common.R.drawable.ic_tag)
